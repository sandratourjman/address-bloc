...
describe("ContactController", () => {
    ...
    describe("#addContact()", () => {
        it("should add a single contact into the book", (done) => {
            this.book.addContact("Alice", "001-100-1010", 'alice@example.com')
                .then((contact) => {
                    expect(contact.name).toBe("Alice");
                    expect(contact.phone).toBe("001-100-1010");
    ...
    describe("#getContacts()", () => {
        it("should return an empty array when no contacts are availalbe", (done) => {
    ...
    describe("search methods", () => {
        ...
        describe("#iterativeSearch()", () => {
            ...
            it("should return null called with an empty array", () => {
        ...
        describe('#binarySearch()', () => {
        	...
        	it("shold return null when contact is not found", (done) => {
        		this.book.addContact(...zelda)
        		.then(() => {
        			this.book.getContacts()
        			.then((contacts) => {
